...
-   Our Homo-Economicus solves $$ \underset{x_i^t \in X_i}{\text{max}} \sum_{t=0}^{\infty} \delta^t \sum_{s_t \in S} p(s_t) U(x_i^t|s_t)$$ $\delta:$ Discount Factor
    ...
    $X_i:$ Set of consumption bundles
:::
...
1.  Non-standard preferences
    ...
    -   Risk preferences: $U(x_i|s,r)$ outcomes compared to some reference point $r$
    -   Social preferences: $U(x_i, x_{-i}|s)$ agents care about others' outcomes $x_{-i}$

2.  Non-standard beliefs

    -   Misperception of $p(s)$
