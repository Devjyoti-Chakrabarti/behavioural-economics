...
-   We want start thinking about how people make decisions about uncertain outcomes and we do that using lotteries. Each lottery has to specify two elements:

    -   payoffs and

    -   the probability of getting those payoffs
:::
